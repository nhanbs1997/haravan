		...
		Nav: {
			...
			mount: function() {
				...
				a(".style--classic .babymenu").each(function() {
					var b = 0;
					a(this).parent().parent().css("display", "block");
				...
				a("#site-header").hasClass("header-scroll") && (a("body").hasClass("template-index") && a("body").addClass("index-margin-fix"), window.lst = a(window).scrollTop(), a(".site-nav.style--classic .submenu").css("top", a(".site-header").outerHeight()), a(window).on("scroll.sticky-header", function() {
					if (!window.blockStickyHeader) {
						...
						0 > b || 5 >= Math.abs(lst - b) || (0 == b ? (this.$siteHeader.removeClass("animate"), this.$siteHeader.removeClass("fix"), this.$siteHeader.removeClass("ready")) : b <= lst && !this.$siteHeader.hasClass("fix") ? (this.$siteHeader.addClass("fix"), setTimeout(function() {
...
*/	
	...
	a(document).on("ready", function() {
		...
		0 < a(".productDetail-page").length && a(".productDetail-page").each(function() {
			...
			/*
		if(shop.template == 'product'){window.CUBER.Product.mount(a(this));	}	*/
